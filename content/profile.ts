...
export const profile: LecturerProfile = {
  ...
  links: {
    ...
    github: '',
    linkedin: '',
    website: 'https://www.udsm.ac.tz/alexander-kivaisi',
  },
};
